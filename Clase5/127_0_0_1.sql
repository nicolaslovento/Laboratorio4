...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-09-2019 a las 15:22:24
...
--
CREATE DATABASE IF NOT EXISTS `ejercicio2` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `ejercicio2`;
...
--
ALTER TABLE `ventas`
  ADD CONSTRAINT `ventas_ibfk_1` FOREIGN KEY (`numero_factura`) REFERENCES `item_ventas` (`numero_factura`),
  ADD CONSTRAINT `ventas_ibfk_2` FOREIGN KEY (`codigo_cliente`) REFERENCES `clientes` (`codigo_cliente`);
--
...
('root', '[{"db":"ejercicio","table":"productos"},{"db":"ejercicio2","table":"clientes"},{"db":"ejercicio","table":"proveedores"},{"db":"ejercicio","table":"prov_prod"}]');
...
('root', '2016-12-15 00:15:00', '{"lang":"es","collation_connection":"utf8mb4_unicode_ci"}');
